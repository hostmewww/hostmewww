...
var SettingsProvider = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        onSettingChange = function (setting) {
                            ...
                            resolve(_this.configuration[name]);
                            _this.eventManager.removeEventListener("onSettingChange", onSettingChange);
                        };
    ...
    SettingsProvider.prototype.loadSettings = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, config, tenantHostname, tenantConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.send({ url: "config.json" })];
                    case 1:
                        response = _a.sent();
                        config = response.toObject();
                        tenantHostname = window.location.hostname;
                        tenantConfig = config[tenantHostname];
                        this.configuration = tenantConfig;
                        return [2 /*return*/, tenantConfig];
                }
            });
        });
    };
