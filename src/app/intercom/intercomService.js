...
var IntercomService = (function () {
    function IntercomService(settingsProvider) {
        this.settingsProvider = settingsProvider;
        this.boot = this.boot.bind(this);
        this.loadConfig = this.loadConfig.bind(this);
        this.loadConfig();
    }
    IntercomService.prototype.loadConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var intercomSetting;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.settingsProvider.getSetting("intercom")];
                    case 1:
                        intercomSetting = _a.sent();
    ...
    IntercomService.prototype.boot = function (appId, intercomSettings) {
    ...
    IntercomService.prototype.update = function (data) {
