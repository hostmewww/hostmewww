...
var NewsLinkResolver = (function () {
    function NewsLinkResolver(permalinkService, newsService) {
        this.permalinkService = permalinkService;
        this.newsService = newsService;
    }
    NewsLinkResolver.prototype.getUriByPermalinkKey = function (permalinkKey) {
    ...
    NewsLinkResolver.prototype.getUriByPermalink = function (permalink) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    NewsLinkResolver.prototype.getHyperlinkByPermalink = function (permalink, target) {
        return __awaiter(this, void 0, void 0, function () {
            var article, hyperlinkModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.newsService.getNewsElementByKey(permalink.targetKey)];
                    case 1:
                        article = _a.sent();
                        if (!article) {
                            return [2 /*return*/, null];
    ...
    return NewsLinkResolver;
}());
exports.NewsLinkResolver = NewsLinkResolver;
