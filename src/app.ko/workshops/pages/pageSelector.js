...
var PageSelector = (function () {
    function PageSelector(pageService, permalinkService, onSelect) {
    ...
    PageSelector.prototype.searchPages = function (searchPattern) {
    ...
    PageSelector.prototype.selectPage = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
