...
var MediaSelector = (function () {
    function MediaSelector(mediaService, permalinkService, onSelect) {
    ...
    MediaSelector.prototype.searchMedias = function (searchPattern) {
        if (searchPattern === void 0) { searchPattern = ""; }
        return __awaiter(this, void 0, void 0, function () {
            var mediaFiles, mediaItems;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        mediaFiles = _a.sent();
                        mediaItems = mediaFiles.map(function (media) { return new mediaItem_1.MediaItem(media); });
    ...
    MediaSelector.prototype.selectMedia = function (media) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
