...
var PagePublisher = (function () {
    function PagePublisher(routeHandler, pageService, permalinkService, siteService, outputBlobStorage) {
    ...
    PagePublisher.prototype.renderPage = function (page) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        buildContentPromise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.permalinkService.getPermalinkByKey(page.permalinkKey)];
                                    case 1:
                                        permalink = _a.sent();
    ...
    PagePublisher.prototype.publish = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pages, results, i, page;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pageService.search("")];
                    case 1:
                        pages = _a.sent();
                        results = [];
                        i = 0;
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.renderPage(pages[i])];
                    case 3:
                        page = _a.sent();
