...
var ButtonHandlers = (function () {
    function ButtonHandlers(buttonModelBinder) {
        this.buttonModelBinder = buttonModelBinder;
    }
    ButtonHandlers.prototype.prepareWidgetOrder = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var model, widgetModel, factoryFunction, widgetOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.buttonModelBinder.nodeToModel(config)];
                    case 1:
                        model = _a.sent();
                        return [4 /*yield*/, this.buttonModelBinder.modelToWidgetModel(model)];
                    case 2:
                        widgetModel = _a.sent();
    ...
    ButtonHandlers.prototype.getWidgetOrderByConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var config;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ButtonHandlers.prototype.getWidgetOrder = function () {
        return Promise.resolve(this.getWidgetOrderByConfig());
    };
    return ButtonHandlers;
}());
exports.ButtonHandlers = ButtonHandlers;
